...
navList.innerHTML = navContent // Coloca a "ul" dentro da navContent criando uma lista não ordenada
mainNav.append(navList) // Depois coloca a lista não ordenada dentro no "nav"

document.querySelector(".siteheader").append(mainNav) // Injeta no final do nó pai(header) onde se encontra a classe .siteheader, ou poderia colocar direto no header document.querySelector("header").append(mainNav);
