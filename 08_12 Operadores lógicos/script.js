...
// Testando duas condiçãoes simultâneas(&&), volume e bolsos:
...
// condição OR(||), basta 1 ser verdadeira:
if (everydayPack.volume > 31 || everydayPack.pocketNum >= 5 ) {
  console.log("Backpack is big")
} else {
  console.log("Backpack is small")
}